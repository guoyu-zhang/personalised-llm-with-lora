...
class ScriptArguments:
    ...
    per_device_train_batch_size: Optional[int] = field(default=5, metadata={"help": "train batch size per device"})
    ...
    output_dir: Optional[str] = field(default="./llama_hh", metadata={"help": "the output directory"})
...
if __name__ == "__main__":
    ...
    train_dataset = get_anthropic_hh_dataset(data_dir="data", sanity_check=script_args.sanity_check, split="train")    
