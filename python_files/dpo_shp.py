...
class ScriptArguments:
    ...
    output_dir: Optional[str] = field(default="./user_shp", metadata={"help": "the output directory"})
...
if __name__ == "__main__":
    ...
    train_dataset = all_dataset.select(range(1300))
    eval_dataset = all_dataset.select(range(1300,1400))
