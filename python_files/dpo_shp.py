...
class ScriptArguments:
    ...
    output_dir: Optional[str] = field(default="./model_hh_shp_1", metadata={"help": "the output directory"})
    log_freq: Optional[int] = field(default=1, metadata={"help": "the logging frequency"})
    
    huggingface_dir_name: Optional[str] = field(default="test", metadata={"help": "the directory to push to on HF"})
...
if __name__ == "__main__":
    ...
    # 2. Load the Anthropic HH dataset
    train_dataset = get_shp_dataset(dataset_hf_path=script_args.dataset_name_or_path ,data_dir="data", sanity_check=script_args.sanity_check, split="train")    
    ...
    training_args = TrainingArguments(
        ...
        run_name=script_args.huggingface_dir_name,
    )
    ...
    dpo_trainer.push_to_hub(script_args.huggingface_dir_name)
