...
if __name__ == "__main__":
    ...
    train_dataset = get_user_dataset(split="train", user_number=script_args.user_number)    

    # 3. Load evaluation dataset
    eval_dataset = get_user_dataset(split="valid", user_number=script_args.user_number)
